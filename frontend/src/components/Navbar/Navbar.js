...
function Navbarr(props) {
    ...
    return (
        <div className="flex w-full h-[75px]">
            <div
                className="w-2/3 min-h-fit pt-[50px] flex items-center justify-ringht font-bold text-[30px] pl-[100px]"
                style={{ color: "#FF0000" }}
            >
            ...
            <div className="w-1/3 min-h-fit flex flex-col items-end justify-center pt-[79px] pr-[125px]">
                <img
                    className="w-1/3 rounded-tl-[2px] rounded-tr-[2px] rounded-bl-[2px]"
                    src={process.env.PUBLIC_URL + "/images/TKS1.jpg"}
                    alt="TinkerSpace"
                />
                <img
                    className="w-1/4 rounded-bl-[2px] rounded-br-[2px]"
                    src={process.env.PUBLIC_URL + "/images/TKS2.jpg"}
                    alt="TinkerHub"
                />
            </div>
        </div>
