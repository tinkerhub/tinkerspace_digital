...
//   const mentors = props.datas.filter(data => data.fields.IsMentor);
//   // const mentees = props.datas.filter(data => !data.fields.IsMentor);
  
//   const [mentees, setMentees] = useState([]);
//    useEffect(() => {
//     setMentees(props.datas.filter(data => !data.fields.IsMentor));
//   }, [props.datas]);

//   // Function to sort cards based on domain
//   const sortCards = (cards) => {
//     return cards.sort((a, b) => {
//       let aIndex = domains.indexOf(a.fields.domain);
//       let bIndex = domains.indexOf(b.fields.domain);
...
//   // Sort mentors
//   const sortedMentors = sortCards(mentors);
...
//             <h2 className="w-[150px] h-[24px] text-[20px] font-bold">{truncate(data.fields['full name'], 12)}</h2>
//             <hr className=' border-t-[2px]' style={{borderColor: '#876100'}} />
//             <p className="w-[150px] h-[22px] text-[18px]">{data.fields.domain ? data.fields.domain : 'Undefined' }</p>
//             <p className="w-[150px] h-[22px] text-[18px]" style={{color: '#876100'}}>{data.fields['to do']}</p>
//           </div>
//         </div>
//       </div>
//     );
...
//                     <h2 className="w-[117.66px] h-[13px] text-[15.69px] font-bold">{truncate(data.fields['full name'], 12)}</h2>
//                     <hr className=' border-t-[1px]' style={{borderColor: '#876100'}} />
//                     <p className="w-[117.66px] h-[8px] text-[14.12px]">{data.fields.domain}</p>
//                     <p className="w-[117.66px] h-[17px] text-[14.12px]" style={{color: '#876100'}}>{data.fields['to do']}</p>
//                 </div>  
//             </div>
//         </div>
//     );
...
// var numberOfCards1 = sortedMentors.length; // get the number of cards after sorting
//   var mentorsSettings = {
...
//              {sortedMentors.map(renderCardMentor)}
//           </Slider>
//         </div>   
//       </div>
